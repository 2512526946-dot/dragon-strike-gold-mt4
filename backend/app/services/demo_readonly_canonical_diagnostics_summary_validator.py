...
def is_safe_demo_readonly_canonical_diagnostics_summary(
    *,
    canonical_summary: object,
) -> bool:
    """Return whether a value is an exact safe G151 diagnostics summary."""

    try:
        return _is_safe_summary(canonical_summary)
    except Exception:
        return False
